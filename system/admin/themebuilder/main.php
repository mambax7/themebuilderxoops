...
include XOOPS_ROOT_PATH . '/modules/system/admin/themebuilder/functions.php';
echo '
	<div style="font-size: 10px; text-align: left; color: #2F5376; padding: 2px 6px; line-height: 18px;">
		...
		<span style="margin: 1px; padding: 4px; border: #E8E8E8 1px solid;">
			<a href="admin.php?fct=themebuilder&op=miseajour"> ' . _AM_SYSTEM_THEMEBUILDER_UPDATE . '</a>
		</span>
		<span style="margin: 1px; padding: 4px; border: #E8E8E8 1px solid;">
			<a href="admin.php?fct=themebuilder&op=apropos"> ' . _AM_SYSTEM_THEMEBUILDER_ABOUT . '</a>
		</span>
	</div></br>';
...
case 'Dashboard':
    ...
    if (!BuilderTableExists($xoopsDB->prefix('config_theme'))) {
        ...
        if (!$xoopsDB->queryF($sqlinstall)) {
            $taktak .= '<span style="color : green;"><img src="../../Frameworks/moduleclasses/icons/16/off.png">' . _AM_SYSTEM_THEMEBUILDER_INSTALL_FAIL1 . '</span>';
        } else {
            ...
            if (!$resultsqltemplate) {
                $taktak .= '<span style="color : green;"><img src="../../Frameworks/moduleclasses/icons/16/off.png">' . _AM_SYSTEM_THEMEBUILDER_TEMPLATE_INSERT_PROBLEM . '</span>';
            } else {
                $taktak .= '<span style="color : green;"><img src="../../Frameworks/moduleclasses/icons/16/on.png">' . _AM_SYSTEM_THEMEBUILDER_TEMPLATE_INSERT_OK . '</span><br>';
            }
        }
    } else {
        $taktak .= '<span style="color : green;"><img src="../../Frameworks/moduleclasses/icons/16/on.png">' . _AM_SYSTEM_THEMEBUILDER_TABLECONFIG_THEME_INSTALLED . '</span><br>';
    }
    ...
    if (!BuilderTableExists($xoopsDB->prefix('config_theme_menu'))) {
        ...
        if (!$xoopsDB->queryF($sqlinstall2)) {
            $taktak .= '<br /><span style="color : green;"><img src="../../Frameworks/moduleclasses/icons/16/off.png">' . _AM_SYSTEM_THEMEBUILDER_INSTALL_FAIL2 . '</span><br>';
        } else {
            $taktak .= '<br><span style="color : green;"><img src="../../Frameworks/moduleclasses/icons/16/on.png">' . _AM_SYSTEM_THEMEBUILDER_TABLECONFIG_THEME_MENU_INSTALL_OK . '</span><br>';
        }
    } else {
        $taktak .= '<span style="color : green;"><img src="../../Frameworks/moduleclasses/icons/16/on.png">' . _AM_SYSTEM_THEMEBUILDER_TABLECONFIG_THEME_MENU_INSTALLED . '</span><br>';
    }

    echo '<fieldset><legend class="label">' . _AM_SYSTEM_THEMEBUILDER_RESUME . '</legend>
			' . $taktak . '
			<span style="color : green;"><img src="../../Frameworks/moduleclasses/icons/16/add.png">  ' . _AM_SYSTEM_THEMEBUILDER_ADVICE . '</span>
		</fieldset>';
...
if (isset($_POST['submitextra']) && $_POST['submitextra'] == 'Submit') {
    ...
    if ($resultr = $xoopsDB->queryF($sqlr)) {
        $message = "" . _AM_SYSTEM_THEMEBUILDER_EXTRA_CSS_MODIFY_OK . "";
    } else {
        $message = "" . _AM_SYSTEM_THEMEBUILDER_EXTRA_CSS_MODIFY_PROBLEM . "";
    }
    //echo $message;
...
$arr = array(
    ...
    "body_bgscroll" => array("des" => "" . _AM_SYSTEM_THEMEBUILDER_SCROLL_BG_TEXTURE . "", "options" => array("fixed", "scroll"), "type" => "tf"),

    "body_background_bg"         => array("des" => "" . _AM_SYSTEM_THEMEBUILDER_BACKGROUND_FOLDER_IMAGES_ADD . "", "options" => oliveewajdii(), "type" => "tf_texture"),
    ...
    "body_background_img_position" => array("des" => "" . _AM_SYSTEM_THEMEBUILDER_POSITION_REPEAT . "", "options" => array("top", "center", "bottom"), "type" => "tf"),

    "body_background_img_scroll"     => array("des" => "" . _AM_SYSTEM_THEMEBUILDER_SCROLL_BG_TEXTURE . "", "options" => array("fixed", "scroll"), "type" => "tf"),
    "scroll_top_enabled"             => array(
        "des"     => "" . _AM_SYSTEM_THEMEBUILDER_SCROLL_TOP_ENABLE . "",
        "options" => array(
            'true'  => 'Activate',
            'false' => 'deactivate'),
        "type"    => "tf"),
    "fontsize"                       => array(
        "des"     => "" . _AM_SYSTEM_THEMEBUILDER_FONT_SIZE . "",
        "options" => array('8px', '9px', '10px', '11px', '12px', '13px', '14px', '15px', '16px', '17px', '18px', '19px', '20px', '21px', '22px', '23px', '24px', '25px', '26px', '27px', '28px', '28px', '30px', '36px', '42px'),
        "type"    => "tf"),
    "fonteffect"                     => array(
        "des"     => "" . _AM_SYSTEM_THEMEBUILDER_FONT_EFFECT . "",
        "options" => array(
            'none',
            'anaglyph',
            'brick-sign',
        ...
        "type"    => "tf"),
    "font_apercu"                    => array(
        "des"     => "" . _AM_SYSTEM_THEMEBUILDER_FONT_USE . "",
        "options" => array(
            "dhyana"                   => "dhyana",
            ...
            "Zeyada"                   => "Zeyada"),
        "type"    => "tfwithapercu"),
    "body_background_color"          => array("des" => "" . _AM_SYSTEM_THEMEBUILDER_COLOR_BODY_BACKGROUND . "", "type" => "color"),

    //.olivee-itemq-BlockcolumnLeft
    "olivee-itemq-BlockcolumnLeft"   => array("des" => "" . _AM_SYSTEM_THEMEBUILDER_COLOR_BLOCK_COLUMN_LEFT_OLIVEE_ITEMQ_BACKGROUND . "", "type" => "color"),
    //.blockTitle
    "blockTitlecolor"                => array("des" => "" . _AM_SYSTEM_THEMEBUILDER_COLOR_BLOCK_TITLE . "", "type" => "color"),
    //.blockTitle
    "blockTitlebackgroundcolor"      => array("des" => "" . _AM_SYSTEM_THEMEBUILDER_COLOR_BLOCK_TITLE_BACKGROUND . "", "type" => "color"),
    //.blockTitle
    "font_apercu_blockTitle"         => array(
        "des"     => "" . _AM_SYSTEM_THEMEBUILDER_BLOCK_TITLE_FONT . "",
        "options" => array(
            "dhyana"                   => "dhyana",
            "droidarabickufi"          => "droidarabickufi",
            "droidarabicnaskh"         => "droidarabicnaskh",
    ...
    "fontsize_blockTitle"            => array(
        "des"     => "" . _AM_SYSTEM_THEMEBUILDER_BLOCK_TITLE_SIZE . "",
        "options" => array('8px', '9px', '10px', '11px', '12px', '13px', '14px', '15px', '16px', '17px', '18px', '19px', '20px', '21px', '22px', '23px', '24px', '25px', '26px', '27px', '28px', '28px', '30px', '36px', '42px'),
        "type"    => "tf"),
    //.blockTitle
    "textalign_blockTitle"           => array("des" => "" . _AM_SYSTEM_THEMEBUILDER_BLOCK_TITLE_TEXT_ALIGN . "", "options" => array('left', 'center', 'right'), "type" => "tf"),

    //.olivee-itemq-BlockcolumnCenter
    "olivee-itemq-BlockcolumnCenter" => array("des" => "" . _AM_SYSTEM_THEMEBUILDER_COLOR_BLOCK_COLUMN_CENTER_OLIVEE_ITEMQ_BACKGROUND . "", "type" => "color"),
    "css_text_extra"                 => array("des" => "" . _AM_SYSTEM_THEMEBUILDER_EXTRA_TEXT_CSS . "", "type" => "textextra"),
    "js_header_text_extra"           => array("des" => "" . _AM_SYSTEM_THEMEBUILDER_EXTRA_TEXT_JS . "", "type" => "textextra"),
    "js_body_text_extra"             => array("des" => "" . _AM_SYSTEM_THEMEBUILDER_BODY_TEXT_JS . "", "type" => "textextra"),
    "google_analytique"              => array("des" => "" . _AM_SYSTEM_THEMEBUILDER_GOOGLE_ANALYTICS_ADD . "", "type" => "textextra"),
    "facebook_og_enabled"            => array(
        "des"     => "" . _AM_SYSTEM_THEMEBUILDER_OPEN_GRAPH_ACTIVATE . "",
        "options" => array(
            'true'  => 'Activate',
            'false' => 'deactivate'),
        "type"    => "tf"),
    "facebook_og_admins"             => array("des" => "" . _AM_SYSTEM_THEMEBUILDER_OPEN_GRAPH_ADMINS . "", "type" => "text"),
    "facebook_og_app_id"             => array("des" => "" . _AM_SYSTEM_THEMEBUILDER_OPEN_GRAPH_APP_ID . "", "type" => "text"),
...
case "tf":
    ...
    foreach ($val as $kes => $valuer) {
        if (is_array($valuer)) {
            ?>
            <tr>
            <td class="head"><label for="<?php echo $key;
            ?>" id="<?php echo $key;
            ?>_label"><?php echo htmlspecialchars($val['des']);
            ?></label></td>
            <td class="even"><select name="<?php echo $key;
            ?>" id="<?php echo $key;
            ?>"><?php
                    foreach ($valuer as $kesy => $valuerr) {
                        ?>
                        <option value="<?php echo $valuerr;
                        ?>" <?php if ($var == $valuerr) {
...
case "tfwithapercu":
    ...
    ?>
    <tr>
        <td class="head"><label for="app_label" id="app_label"><?php echo "" . _AM_SYSTEM_THEMEBUILDER_PREVIEW . ""; ?></label></td>
        <td class="even">
...
case "tf_texture":
    ...
    foreach ($val as $kes => $valuer) {
        if (is_array($valuer)) {
            ...
            <tr>
            <td class="head"><label for="<?php echo $key;
            ?>_texture" id="<?php echo $key;
            ?>_texture"><?php echo htmlspecialchars($val['des']);
            ?></label></td>
            <td class="even"><select name="<?php echo $key;
            ?>" id="<?php echo $key;
            ?>"><?php
    ...
    $output = '
												<tr>
													<td class="head">' . _AM_SYSTEM_THEMEBUILDER_BACKGROUND_ROTATE . '</td>
													<td class="even">';
    ...
    ?>
    <tr>
        <td class="head"><label for="appp_label" id="appp_label"><?php echo "" . _AM_SYSTEM_THEMEBUILDER_PREVIEW . ""; ?></label></td>
        <td class="even">
        ...
        $(document).ready(function () {
            $("#<?php echo $key;?>").on("change", function () {
                ...
                $.ajax({
                    url: 'admin/themebuilder/ajax.php',
                    data: {<?php echo $key;?>:
                x_value_texture, repeat
                :
                x_value_texture_repeat, bgpos
                :
                x_value_texture_pos, bgscroll
                :
                x_value_texture_bgscroll
            },
                type: 'post',
                    success
                :
...
case "upload":
    ...
    <tr>
        ...
        <td class="even">
            ...
            <div style="float: right;" align="right" id='upload1'><span><?php echo "" . _AM_SYSTEM_THEMEBUILDER_FAVICON_UPLOAD_FILE_IMAGE . ""; ?><span></div>
...
< link rel="icon" type="image/png" href="/uploads/favicon.png" />
    ...
    <tr>
        <td class="head"><?php echo "" . _AM_SYSTEM_THEMEBUILDER_FAVICON_UPLOAD_IMAGE_URL . ""; ?></td>
        <td class="even">
    ...
    case 'modifymenu':
        ...
        if (isset($_POST['action']) && $_POST['action'] == 'modify_menu-save') {
            ...
            if ($resultr = $xoopsDB->queryF($sqlr)) {
                ...
                $message = _AM_SYSTEM_THEMEBUILDER_MENU_MODIFY_PROBLEM;
            }
            //echo $message;
        ...
        if ($menuid) {
            echo '<form name="add_menu" action="" method="post">
											...
											<tr>
								<th colspan="2" style="color: red;">' . _AM_SYSTEM_THEMEBUILDER_MENU_MODIFY . '</th>
								<tr>
									<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_CATEGORY_MENU . '</td>
									<td class="even">
								...
								<tr>
								<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_CATEGORY_SKIN . '</td>
									<td class="even">';
            ...
            $data = array(
                ...
                'animation'    => array(
                    ...
                    'option'  => 'tn'),
                'stickyoffset' => array('des'     => 'stiky offset',
                                        'options' => array("0"   => "0",
                                                           "10"  => "10",
                                                           "20"  => "20",
                                                           "30"  => "30",
    ...
    case 'modifymenuitem':
        ...
        if ($menuitemid) {
            echo '
								...
								<tr>
									<th colspan="2" style="color: red;">' . _AM_SYSTEM_THEMEBUILDER_MENU_ITEM_MODIFY . '</th>
								<tr>
								<tr>
								<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_MENU_PARENT . '</td>
									<td class="even">
            ...
            echo '</td>
								...
								<tr>
								<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_ITEM_PARENT . '</td>
									<td class="even">
								...
								<tr>
								<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_TITLE . 'tittttre</td>
									<td class="even">
								...
								<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_LINK . '</td>
									<td class="even">
											...
											<input id="link" name="link" type="text" size="40" value="" style="width: 190px;"/>
																...
																<tr>
								<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_ORDER . '</td>
									<td class="even">
...
$("#catmenuparent").on("change",function(){
    ...
    case 'Menu':
            ...
            if ($catmenu != '' && $catskin != '' && $_POST['select_direction'] != '' && $_POST['select_animation'] != '') {
                ...
                if ($filecount == 0) {
                    ...
                    if ($result = $xoopsDB->queryF($sql)) {
                        $message = _AM_SYSTEM_THEMEBUILDER_MENU_REGISTER_OK;
                        echo $message;
                        //redirect_header("admin.php?fct=themebuilder&op=Menu", 5, $message);
                        //exit();
                    } else {
                        $message = _AM_SYSTEM_THEMEBUILDER_MENU_REGISTER_PROBLEM;
                        echo $message;
                    }
                } else {
                    $message = _AM_SYSTEM_THEMEBUILDER_MENU_TITLE_EXISTS;
                    echo $message;
                }
                ...
                if ($filecount == 0) {
                    ...
                    if ($result = $xoopsDB->queryF($sql)) {
                        $message = _AM_SYSTEM_THEMEBUILDER_MENU_ITEM_ADD_OK;
                        echo $message;
                    } else {
                        $message = _AM_SYSTEM_THEMEBUILDER_MENU_ITEM_ADD_PROBLEM;
                        echo $message;
                    }
                } else {
                    $message = _AM_SYSTEM_THEMEBUILDER_MENU_ITEM_TITLE_EXISTS;
                    echo $message;
                }
            } else {
                $message = _AM_SYSTEM_THEMEBUILDER_MENU_ITEM_ADD_PROBLEM;
        ...
        echo '
										...
										<form name="add_menu" action="" method="post">
																			...
																			<tr>
																<th colspan="2" style="color: red;">' . _AM_SYSTEM_THEMEBUILDER_MENU_NEW . '</th>
																<tr>
																	<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_CATEGORY_MENU . '</td>
																	<td class="even">
																			<div class="input-append color">
        ...
        echo '
																...
																<tr>
																<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_MENU_DIRECTION . '</td>
																	<td class="even">';
        ...
        echo '</td>
																...
																<tr>
																<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_MENU_ANIMATION . '</td>
																	<td class="even">';
        $SELECT_animation = array("dropdowns_animation-none"   => "dropdowns_animation-none",
                                  "dropdowns_animation-anim_1" => "dropdowns_animation-anim_1",
                                  "dropdowns_animation-anim_2" => "dropdowns_animation-anim_2",
                                  "dropdowns_animation-anim_3" => "dropdowns_animation-anim_3",
                                  "dropdowns_animation-anim_4" => "dropdowns_animation-anim_4",
        ...
        echo '</td>
																...
																<tr>
																<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_MENU_STICKY . '</td>
																	<td class="even">';
        $SELECT_stickyoffset = array("0"   => "0",
                                     "10"  => "10",
                                     "20"  => "20",
                                     "30"  => "30",
                                     "40"  => "40",
        ...
        echo '</td>
																...
																<tr>
																<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_MENU_COLOR . '</td>
																	<td class="even">';
        ...
        echo '
																...
																<th  colspan="2" style="color: red;">' . _AM_SYSTEM_THEMEBUILDER_MENU_ITEM_NEW . '</th>
																<tr>
																<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_MENU_PARENT . '</td>
																	<td class="even">
																	<select id="catmenuparent" name="catmenuparent" class="select" style="width:200px">';
        ...
        echo '
																...
																<tr>
																<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_MENU_ITEM_PARENT . '</td>
																	<td class="even">
																	<select id="cat_id" name="cat_id" class="select" style="width:200px">
																			</select>
																	</td>
																...
																<tr>
																<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_TITLE . '</td>
																	<td class="even">
																			<div class="input-append color">
													...
													$("#icons").on("change",function(){
														...
														$.ajax({
															...
															error : function(resp){}
																...
																<tr>
																<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_CLASS_PARENT . '</td>
																	<td class="even">';
    ...
    case 'modifyslider':
        ...
        if ($_POST['action'] == 'modify_slide-save') {
            ...
            if ($resultr = $xoopsDB->queryF($sqlr)) {
                $message = _AM_SYSTEM_THEMEBUILDER_SLIDER_MODIFY_OK;
                //echo $message;
                redirect_header("admin.php?fct=themebuilder&op=Slider", 5, $message);
                exit();
            } else {
                $message = _AM_SYSTEM_THEMEBUILDER_SLIDER_ITEM_MODIFY_PROBLEM;
                //echo $message;
                redirect_header("admin.php?fct=themebuilder&op=Slider", 5, $message);
                exit();
            }
        ...
        if ($sliderid) {
            echo ' <form name="add_slide" action="" method="post">
						    ...
						    <tr>
								...
								<tr>
									<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_SLIDER_TITLE2 . '</td>
									<td class="even">
								...
								<tr>
								<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_SLIDER_THEME . ' slider theme</td>
									<td class="even">';

            $SELECT_slider = array("flexslider"                    => "flexslider",
                                   "orbit"                         => "orbit",
                                   "bxslider"                      => "bxslider",
    ...
    case 'modifyslideritem':
        ...
        if ($_POST['action'] == 'modify_item_slide-save') {
            ...
            if ($resultr = $xoopsDB->queryF($sqlr)) {
                ...
                $message = _AM_SYSTEM_THEMEBUILDER_SLIDER_MODIFY_PROBLEM;
                //echo $message;
                redirect_header("admin.php?fct=themebuilder&op=Slider", 5, $message);
                exit();
            }
        ...
        if ($slideritemid) {
            echo '<form name="add_slide" action="" method="post">
											...
											<tr>
											<tr>
								<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_SLIDER_PARENT . ' Slider parent</td>
									<td class="even">
            ...
            echo '
								...
								<tr>
								<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_IMAGE_UPLOAD . ' Upload image</td>
...
<div id='upload' ><span>Upload File<span></div><span id='status' ></span>
    ...
    case 'Slider':
        ...
        if (isset($_POST['action']) && $_POST['action'] == 'add_slide-save') {
            ...
            if ($titreslider != '' && $slider_theme != '') {
                ...
                if ($filecount == 0) {
                    ...
                    if ($result = $xoopsDB->queryF($sql)) {
                        $message = _AM_SYSTEM_THEMEBUILDER_SLIDER_REGISTER_OK;
                        echo $message;
                    } else {
                        $message = _AM_SYSTEM_THEMEBUILDER_SLIDER_REGISTER_PROBLEM;
                        echo $message;
                    }
                } else {
                    $message = _AM_SYSTEM_THEMEBUILDER_SLIDER_MENU_TITLE_EXISTS;
                    echo $message;
                }
                ...
                if ($filecount == 0) {
                    ...
                    if ($result = $xoopsDB->queryF($sql)) {
                        ...
                        $message = _AM_SYSTEM_THEMEBUILDER_SLIDER_CONFIG_PROBLEM;
                        echo $message;
                    }
                } else {
                    $message = _AM_SYSTEM_THEMEBUILDER_SLIDER_MENU_TITLE_EXISTS;
        ...
        echo '		<form name="add_slide" action="" method="post">
											<table width="100%" cellpadding="0" cellspacing="0" class="table ct_table">
						    <tr>
								<th colspan="2" style="color: red;">' . _AM_SYSTEM_THEMEBUILDER_SLIDER_ITEM_NEW2 . '</th>

								<tr>
									<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_SLIDER_TITLE . '</td>
									<td class="even">
								...
								<tr>
								<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_SLIDER_THEME . '</td>
									<td class="even">';
...
<tr id="optionslider" name="optionslider" >
							...
							<tr>
								<th colspan="2" style="color: red;">' . _AM_SYSTEM_THEMEBUILDER_SLIDER_ITEM_NEW . '</th>

								<tr>
								<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_SLIDER_PARENT . '</td>
									<td class="even">
        ...
        echo '
								...
								<tr>
								<tr>
								<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_IMAGE_UPLOAD . '</td>
								<input type="hidden" id="location" name="location" value="' . $location . '" />
									<td class="even">';
        echo "
...
<div id='upload' ><span>" . _AM_SYSTEM_THEMEBUILDER_FILE_UPLOAD . "<span></div><span id='status' ></span>
		<ul id='files' ></ul>
        ...
        echo '
								...
								<tr>
								<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_SLIDER_ITEM_TITLE . '</td>
									<td class="even">
								...
								<tr>
								<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_SLIDER_ITEM_URL . '</td>
									<td class="even">
								...
								<tr>
								<td class="head" style="padding-left: 15px; font-family:Arial; font-size: 10px;">' . _AM_SYSTEM_THEMEBUILDER_SLIDER_ITEM_ORDER . '</td>
									<td class="even">
...
<br></fieldset>';
    ...
    case 'apropos':
        ...
        echo "<div style='margin-top: 10px; color: #33538e; margin-bottom: 4px; font-size: 18px; line-height: 18px; font-weight: bold; display: block;'>Beta (1.1)</div>";
        ...
        echo "<tr>";
        echo "<th colspan='2' class='bg3' align='left'><strong>" ._AM_SYSTEM_THEMEBUILDER_AUTHOR_INFO ."</strong></th>";
        echo "</tr>";
        echo "<tr>";
        echo "<td class='head' width='150px' align='left'>" ._AM_SYSTEM_THEMEBUILDER_AUTHOR_NAME ."</td>";
        echo "<td class='even' align='left'>" . $author_name . "</td>";
        echo "</tr>";
        echo "<tr>";
        echo "<td class='head' width='150px' align='left'>" ._AM_SYSTEM_THEMEBUILDER_AUTHOR_WEBSITE ."</td>";
        echo "<td class='even' align='left'><a href='http://xoops.org' target='_blank'>xoops.org</a></td>";
        echo "</tr>";
        echo "<tr>";
        echo "<td class='head' width='150px' align='left'>" ._AM_SYSTEM_THEMEBUILDER_AUTHOR_WEBSITE_FR ."</td>";
...
<div class="rmmenuicon">
	...
	<a href="admin.php?fct=themebuilder&op=miseajour" title="' . _AM_SYSTEM_THEMEBUILDER_UPDATE . '"><img src="../../Frameworks/moduleclasses/icons/32/penguin.png" alt="' . _AM_SYSTEM_THEMEBUILDER_UPDATE . '"><span>' . _AM_SYSTEM_THEMEBUILDER_UPDATE . '</span></a>
	<a href="admin.php?fct=themebuilder&op=apropos" title="' . _AM_SYSTEM_THEMEBUILDER_ABOUT . '"><img width="32px" src="../../Frameworks/moduleclasses/icons/32/about.png" alt="' . _AM_SYSTEM_THEMEBUILDER_ABOUT . '"> <span>' . _AM_SYSTEM_THEMEBUILDER_ABOUT . '</span></a></div>
</div>
