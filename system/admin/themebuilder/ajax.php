...
if ($_POST['brandfont'] && $_POST['size']) {
    if (in_array($_POST['brandfont'], array(
        'amiri',
        'tharlon',
        'dhyana',
        'droidarabickufi',
...
if ($_POST['x_optionslider'] == 'orbit') {
    ...
    foreach ($data as $linha => $value) {
        ...
        <tr class='myTableRow'>
            <td class='head' style="padding-left: 15px; font-family:Arial,sans-serif; font-size: 10px;"><?php echo $value['des'];
        ?></td>
            <td class='even'>
                <?php
                if ($value['option'] == 'tn') {
                    ?>
                    <select name="orbit_<?php echo $linha;
                    ?>" id="orbit_<?php echo $linha;
                    ?>"><?php
                        foreach ($value['options'] as $kesy => $valuerr) {
                            $selected = ($valuerr == $unserilise[$linha]) ? ' selected="selected"' : '';
                            echo "<option value=" . $valuerr . " " . $selected . ">" . $valuerr . "</option>";
        ...
        ?></td>
            <td class='even'>
                ...
                if ($value['option'] == 'tn') {
                    ...
                    <select name="bxslider_<?php echo $linha;
                    ?>" id="bxslider_<?php echo $linha;
                    ?>"><?php
                        foreach ($value['options'] as $kesy => $valuerr) {
                            $selected = ($valuerr == $unserilise[$linha]) ? ' selected="selected"' : '';
                            echo "<option value=" . $valuerr . " " . $selected . ">" . $valuerr . "</option>";
        ...
        ?></td>
            <td class='even'>
                ...
                if ($value['option'] == 'tn') {
                    ...
                    <select name="skitter_slider_<?php echo $linha;
