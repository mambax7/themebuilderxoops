...
if ($_POST['brandfont'] && $_POST['size']) {
    ...
    if (in_array(
        ...
        $g_text
            = '0123456789 <br> ABCDEFGHIJKLMNOPQRSTUVWXYZ <br> abcdefghijklmnopqrstuvwxyz <br> أ	ب	ج	د	ﻫ	و	ز	ح	ط	ي	ك	ل	م	ن	س	ع	ف	ص	ق	ر	ش	ت	ث	خ	ذ	ض	ظ	غ';
...
if ($_POST['x_optionslider'] == 'orbit') {
    ...
    foreach ($data as $linha => $value) {
        ...
        <tr class='myTableRow'>
            <td class='head' style="padding-left: 15px; font-family:Arial,sans-serif; font-size: 10px;"><?php echo $value['des']; ?></td>
            <td class='even'>
                <?php
                if ($value['option'] == 'tn') {
                    ?>
